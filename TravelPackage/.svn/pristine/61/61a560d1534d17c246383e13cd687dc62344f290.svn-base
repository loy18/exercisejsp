...
public class AtchFileServiceImpl implements IAtchFileService {
	...
	@Override
	public AtchFileVO saveAtchFileList(HttpServletRequest req, String dir) {
			...
			for(Part part : req.getParts()) {
				...
				if(fileName != null && !fileName.equals("")) {
					...
					do {
						...
						saveFilePath = dir + File.separator + saveFileName;
					...
					atchFileVO.setAtchFileDeSav(saveFileName);
					atchFileVO.setAtchFileDeSize(fileSize);
					atchFileVO.setAtchDeOg(orignlFileNm);
					atchFileVO.setAtchFileDePath(saveFilePath);
					atchFileVO.setAtchFileDeExt(fileExtension);
