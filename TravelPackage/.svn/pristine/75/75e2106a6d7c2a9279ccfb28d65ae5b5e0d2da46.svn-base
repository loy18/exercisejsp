<link rel="canonical"
	href="https://getbootstrap.kr/docs/5.1/examples/modals/">
<!-- Bootstrap core CSS -->
<link href="/TravelPackage/assets/dist/css/bootstrap.min.css"
	rel="stylesheet">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content rounded-6 shadow">
				...
				<div class="modal-footer flex-column border-top-0">
					<button type="button"
						class="btn btn-lg btn-primary w-100 mx-0 mb-2">Save
						changes</button>
