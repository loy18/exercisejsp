...
<body>
	<div id=wrapper align="center">
		...
		<form action="<%=request.getContextPath()%>/login_check.do"
			method="post">
<br /><br /><br /><br />
			<h2>로그인</h2>
			<br /> <br /> 
			...
			<br/>
			<br/>
			<input class=A1 style="font-size:15px " placeholder="   아이디(이메일 계정)" type="text" name="memMail"><br /> <br /> 
			<input class=A1 style="font-size:15px" placeholder="   비밀번호" type="password" name="memPw"><br /> <br />
