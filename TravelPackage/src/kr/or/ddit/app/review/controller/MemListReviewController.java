...
@WebServlet("/review/MemReviewList.do")
public class MemListReviewController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<ReviewVO> reviewList = reviewService.searchList(memMail);
		...
		RequestDispatcher dispatcher = 
				req.getRequestDispatcher("/review/MemReviewList.jsp");
