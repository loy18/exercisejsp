...
class ShareData{
	...
	*/
	volatile private boolean isOk = false; 	//원주율 계산 완료여부변수
...
class CalcPiThread extends Thread{
	...
	/*
  	...
  	*/
		...
		sd.setResult(sum * 4);	//계산된 원주율을 공통객체에 저장
		sd.setOk(true);		// 계산이 완료됨을 나타냄
	}
}
